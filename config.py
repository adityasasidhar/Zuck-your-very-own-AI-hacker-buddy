...
class AgentConfig(BaseModel):
    ...
    openai_api_key: Optional[str] = Field(default=None, description="OpenAI API key (or use OPENAI_API_KEY env var)")
    anthropic_api_key: Optional[str] = Field(default=None, description="Anthropic API key (or use ANTHROPIC_API_KEY env var)")
